 ...
 */
public final class LineDomainAxisMinValueExpressionProperty extends ExpressionProperty
{
    private final JRDesignLinePlot plot;

    public LineDomainAxisMinValueExpressionProperty(JRDesignLinePlot plot, JRDesignDataset dataset)
    {
        super(plot, dataset);
        this.plot = plot;
    }
    ...
    {
        return JRDesignLinePlot.PROPERTY_DOMAIN_AXIS_MINVALUE_EXPRESSION;
    }
