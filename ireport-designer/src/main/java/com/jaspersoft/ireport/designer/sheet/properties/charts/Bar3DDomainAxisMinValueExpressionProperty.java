 ...
 */
public final class Bar3DDomainAxisMinValueExpressionProperty extends ExpressionProperty
{
    private final JRDesignBar3DPlot plot;

    public Bar3DDomainAxisMinValueExpressionProperty(JRDesignBar3DPlot plot, JRDesignDataset dataset)
    {
        super(plot, dataset);
        this.plot = plot;
    }
    ...
    {
        return JRDesignBar3DPlot.PROPERTY_DOMAIN_AXIS_MINVALUE_EXPRESSION;
    }
