 ...
 */
public final class Bar3DDomainAxisMaxValueExpressionProperty extends ExpressionProperty
{
    private final JRDesignBar3DPlot plot;

    public Bar3DDomainAxisMaxValueExpressionProperty(JRDesignBar3DPlot plot, JRDesignDataset dataset)
    {
        super(plot, dataset);
        this.plot = plot;
    }
    ...
    {
        return JRDesignBar3DPlot.PROPERTY_DOMAIN_AXIS_MAXVALUE_EXPRESSION;
    }
