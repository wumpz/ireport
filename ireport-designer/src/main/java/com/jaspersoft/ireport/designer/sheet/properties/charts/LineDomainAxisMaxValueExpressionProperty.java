 ...
 */
public final class LineDomainAxisMaxValueExpressionProperty extends ExpressionProperty
{
    private final JRDesignLinePlot plot;

    public LineDomainAxisMaxValueExpressionProperty(JRDesignLinePlot plot, JRDesignDataset dataset)
    {
        super(plot, dataset);
        this.plot = plot;
    }
    ...
    {
        return JRDesignLinePlot.PROPERTY_DOMAIN_AXIS_MAXVALUE_EXPRESSION;
    }
