 ...
 */
public final class AreaDomainAxisMinValueExpressionProperty extends ExpressionProperty 
{
    private final JRDesignAreaPlot plot;

    public AreaDomainAxisMinValueExpressionProperty(JRDesignAreaPlot plot, JRDesignDataset dataset)
    {
        super(plot, dataset);
        this.plot = plot;
    }
    ...
    {
        return JRDesignAreaPlot.PROPERTY_DOMAIN_AXIS_MINVALUE_EXPRESSION;
    }
