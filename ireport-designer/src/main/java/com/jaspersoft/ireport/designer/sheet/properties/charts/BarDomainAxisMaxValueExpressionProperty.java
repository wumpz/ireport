 ...
 */
public final class BarDomainAxisMaxValueExpressionProperty extends ExpressionProperty
{
    private final JRDesignBarPlot plot;

    public BarDomainAxisMaxValueExpressionProperty(JRDesignBarPlot plot, JRDesignDataset dataset)
    {
        super(plot, dataset);
        this.plot = plot;
    }
    ...
    {
        return JRDesignBarPlot.PROPERTY_DOMAIN_AXIS_MAXVALUE_EXPRESSION;
    }
