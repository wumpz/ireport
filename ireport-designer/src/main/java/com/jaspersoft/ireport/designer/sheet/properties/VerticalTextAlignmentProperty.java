 ...
 */
public final class VerticalTextAlignmentProperty extends EnumProperty
{
    private final JRTextAlignment element;

    @SuppressWarnings("unchecked")
    public VerticalTextAlignmentProperty(JRTextAlignment element)
    {
        super(VerticalTextAlignEnum.class, element);
    ...
    {
        return element.getVerticalTextAlign();
    }

    @Override
    public Object getOwnPropertyValue()
    {
        return element.getOwnVerticalTextAlign();
    }
    ...
    {
        element.setVerticalTextAlign((VerticalTextAlignEnum)alignment);
    }
