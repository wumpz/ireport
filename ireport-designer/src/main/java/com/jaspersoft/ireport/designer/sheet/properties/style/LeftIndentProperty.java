...
public class LeftIndentProperty extends IntegerProperty{
    ...
    public LeftIndentProperty(JRBaseStyle style)
    {
        super(style);
        this.style = style;
    }
    ...
    {
        return style.getParagraph().getLeftIndent() == null ? new Integer(0) : style.getParagraph().getLeftIndent();
    }

    @Override
    public Integer getOwnInteger()
    {
        return style.getParagraph().getOwnLeftIndent() == null ? new Integer(0) : style.getParagraph().getOwnLeftIndent();
    }
    ...
    public void setInteger(Integer num)
    {
        ...
        {
            style.getParagraph().setLeftIndent(null);
        }
        else
        {
            style.getParagraph().setLeftIndent(num);
        }
    }
