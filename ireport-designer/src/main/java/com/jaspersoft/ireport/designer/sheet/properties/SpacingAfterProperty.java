...
public class SpacingAfterProperty extends IntegerProperty{
    ...
    public SpacingAfterProperty(JRDesignTextElement element)
    {
        super(element);
    ...
    {
        return element.getParagraph().getSpacingAfter() == null ? new Integer(0) : element.getParagraph().getSpacingAfter();
    }

    @Override
    public Integer getOwnInteger()
    {
        return element.getParagraph().getOwnSpacingAfter() == null ? new Integer(0) : element.getParagraph().getOwnSpacingAfter();
    }
    ...
    public void setInteger(Integer num)
    {
        ...
        {
            element.getParagraph().setSpacingAfter(null);
        }
        else
        {
            element.getParagraph().setSpacingAfter(num);
        }
    }
