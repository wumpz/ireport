 ...
 */
public final class AreaDomainAxisMaxValueExpressionProperty extends ExpressionProperty
{
    private final JRDesignAreaPlot plot;

    public AreaDomainAxisMaxValueExpressionProperty(JRDesignAreaPlot plot, JRDesignDataset dataset)
    {
        super(plot, dataset);
        this.plot = plot;
    }
    ...
    {
        return JRDesignAreaPlot.PROPERTY_DOMAIN_AXIS_MAXVALUE_EXPRESSION;
    }
