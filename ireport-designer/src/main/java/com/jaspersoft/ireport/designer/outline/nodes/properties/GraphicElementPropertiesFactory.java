...
import com.jaspersoft.ireport.designer.sheet.properties.HorizontalGraphicAlignmentProperty;
...
import com.jaspersoft.ireport.designer.sheet.properties.VerticalGraphicAlignmentProperty;
...
public class GraphicElementPropertiesFactory {
    ...
    public static List<Sheet.Set> getGraphicPropertySets(JRDesignGraphicElement element, JasperDesign jd)
    {
        ...
        if (element instanceof JRDesignImage)
        {
            ...
            imagePropertySet.put(new HorizontalGraphicAlignmentProperty( (JRDesignImage)element ));
            imagePropertySet.put(new VerticalGraphicAlignmentProperty( (JRDesignImage)element ));
