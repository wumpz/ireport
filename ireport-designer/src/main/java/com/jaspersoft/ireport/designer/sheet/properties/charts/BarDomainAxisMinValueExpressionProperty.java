 ...
 */
public final class BarDomainAxisMinValueExpressionProperty extends ExpressionProperty 
{
    private final JRDesignBarPlot plot;

    public BarDomainAxisMinValueExpressionProperty(JRDesignBarPlot plot, JRDesignDataset dataset)
    {
        super(plot, dataset);
        this.plot = plot;
    }
    ...
    {
        return JRDesignBarPlot.PROPERTY_DOMAIN_AXIS_MINVALUE_EXPRESSION;
    }
