...
public class SpacingBeforeProperty extends IntegerProperty{
    ...
    public SpacingBeforeProperty(JRDesignTextElement element)
    {
        super(element);
    ...
    {
        return element.getParagraph().getSpacingBefore() == null ? new Integer(0) : element.getParagraph().getSpacingBefore();
    }

    @Override
    public Integer getOwnInteger()
    {
        return element.getParagraph().getOwnSpacingBefore() == null ? new Integer(0) : element.getParagraph().getOwnSpacingBefore();
    }
    ...
    public void setInteger(Integer num)
    {
        ...
        {
            element.getParagraph().setSpacingBefore(null);
        }
        else
        {
            element.getParagraph().setSpacingBefore(num);
        }
    }
